 ...
 <div class="main_container">
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Agregar Proveedor</h4>
            </div>
            ...
            <form action="{{route('proveedores.store')}} " method="post" accept-charset="utf-8">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 div-input-modal">
                    <label for="first-name">Cuit</label>
                    <input name="cuit" type="text" id="first-name1" class="form-control col-md-7 col-xs-12">
                  </div>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Modificar Proveedor</h4>
            </div>
            <div class="modal-body cuerpo-modal">
              <form action="  " method="get" accept-charset="utf-8">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 div-input-modal">
                    <label for="first-name">Cuit</label>
                    <input name="descripcion" id="cuit" type="text" id="first-name1" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
              </form>
    ...
    <div class="right_col" role="main">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Administrar Proveedor</h2>
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              </li>
              <li class="">
                <button type="button" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#modal-agregar">Agregar Proveedor</button>
...
<script type="text/javascript">
  $(function(){
    ...
    $('#send_delete').on('click', function(){
      ...
      var url = "proveedores/" + idSeleccionado;
      $.ajax({  
        type: "DELETE",
        url: url,
    ...
    $('#enviar_m').on('click', function(){
      ...
      var urledit = "proveedores/" + idSeleccionado;
      $.ajax({  
        type: "put",
        url: urledit,
        data: {
