    ...
    <div class="">  
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Administrar Ajuste Del Stock</h2>
            ...
            <div class="x_content">
                <div class="row">
                  <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      ...
                      <input type="text" id="nro_documento"  class="form-control col-md-7 col-xs-12">
                    </div> 

                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <label class="control-label" for="first-name">Fecha</label>
                      <div class='input-group date' id='myDatepickerAjuste'>
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <input id="observaciones" type="text" id="observaciones"  class="form-control col-md-7 col-xs-12">
                  </div> 
              ...
              <div class="row">
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <input id="traza" type="text" id="documento"  class="form-control col-md-7 col-xs-12">
                  </div> 
                  <div class="col-md-1 col-sm-1 col-xs-12">
                    <button class="btn btn-primary btn-calidad btn-sm btn-margin" id="trazabilidadbusqueda"><i class="fa fa-search"></i></button>
                  </div>
              ...
              <div class="form-group">
                <div class="col-md-9 col-sm-9 col-xs-12 ">
                  <button type="" id="busquedajuste" class="btn btn-primary  btn-sm">Buscar</button>
                  <button type="" id="limpiarbusqueda" class="btn btn-success  btn-sm">Limpiar</button>
                </div>
              </div>
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li class="">
                <button type="button" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#modal-agregar">Agregar Ajuste</button>
            ...
            <div class="x_content">
              ...
              <table id="datatable-buttons" class="table table-striped table-bordered table-hover" style="width: 100%">
                ...
                <tbody id="cuerpo_tabla_ajuste">
                  <!--
                  <tr>
                    <td>SR-5716-1</td>
                    <td>57 x 1,6 x 6000 CC RI LF</td>
                    <td><span class="label label-success">Terminado</span></td>
                    <td>Z1</td>
                    <td>AIRBAG</td>
                    <td>170</td>
...
<script type="text/javascript">
   $(function(){
    ...
    $("#finalizar").on("click", function(){
      ...
      $("#cuerpo_tabla_ajuste tr").each(function(index, elemento){
      ...
      $.ajax({  
        ...
        success: function(data){
          ...
          for(var i=0;  i< objetos.length; i++)
          {
            ...
            $("#cuerpo_tabla_ajuste").append(template);
          }
        }
    ...
    $(document).on("change", ".js-cantidadeseada", function(){
      ...
      if($.isNumeric(valorActual))
      {
        ...
        if(valorActual<=0)
        {
          ...
          return;*/
          var resta = max-parseInt(valorActual*-1);
          console.log('resta',resta)
          $(hermanoTdTotal).val(resta);
          
        }else{
          var suma = max+valorActual;

          $(hermanoTdTotal).val(suma);
        }
/*
        if(max<valorActual)
        {
    ...
    $("#busquedajuste").on('click', function(){
      var fecha = $("#fecha").val();
      var nro = $("#nro_documento").val();
      var observ = $("#observaciones").val();
      var medida = $("#medida_id").val();
      var traza = $("#traza").val();
