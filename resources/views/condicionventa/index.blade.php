...
@section('content')
 ...
 <!--  modal Agregar Condición de venta -->
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Agregar Condición de venta</h4>
            </div>
            <div class="modal-body cuerpo-modal">
              <form action="{{route('condicionventas.store')}}" method="post" accept-charset="utf-8">
      ...
      <!-- /modals agregar Condición de venta-->
      ...
      <!--  modal modifcar Condición de venta -->
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Modificar Condición de Venta</h4>
            </div>
            <div class="modal-body cuerpo-modal">
    ...
    <div class="right_col" role="main">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Administrar Condición de Venta</h2>
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              </li>
              <li class="">
                <button type="button" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#modal-agregar">Agregar</button>
...
<script type="text/javascript">
  $(function(){
    ...
    $('#send_delete').on('click', function(){
        ...
        var url = "condicionventas/" + idSeleccionado;
        $.ajax({  
          type: "DELETE",
          url: url,
    ...
    $('#enviar_m').on('click', function(){
      ...
      var urledit = "condicionventas/" + idSeleccionado;
      $.ajax({  
        type: "put",
        url: urledit,
        data: {
