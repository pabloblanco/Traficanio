        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Agregar Norma</h4>
            </div>
              <div class="modal-body cuerpo-modal">
            <form action="{{route('normas.store')}} " method="post" accept-charset="utf-8">
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel2">Modificar Norma</h4>
            </div>
            <div class="modal-body cuerpo-modal">
        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li class="">
                <button type="button" class="btn btn-default btn-sm"  data-toggle="modal" data-target="#modal-agregar">Agregar Norma</button>
...
<script type="text/javascript">
  $(function(){
    ...
    $('#enviar_m').on('click', function(){
      ...
      var urledit = "normas/" + idSeleccionado;
      $.ajax({  
        type: "put",
        url: urledit,
        data: {
